...
class Spear(Weapon):
    def __init__(self):
        super().__init__(name="Spear",
                         description="A long, narrow-bladed Spear.",
                         value=1,
                         damage=1)
...
class Gun(Weapon):
    def __init__(self):
        super().__init__(name="Gun",
                         description="Gun with single bullet.",
                         value=1,
                         damage=1)
...
class Arrow(Weapon):
    def __init__(self):
        super().__init__(name="Arrow",
                         description="Arrow with sharp edge.",
                         value=1,
                         damage=1)
...
class ShortPortions(Portions):
    def __init__(self):
        super().__init__(name="Small Portion",
                         description="A Small Portion",
                         value=5,
                         amt =1 ,
                         health=50)